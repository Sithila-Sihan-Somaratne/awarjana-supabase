...
import TaskProgress from '../../components/worker/TaskProgress'
        ...
        <div className="mb-6">
          ...
          <div className="hidden sm:block">
            <nav className="flex space-x-4">
              {[
                { id: 'jobcards', label: 'Job Cards', icon: <ClipboardCheck className="h-5 w-5" />, count: jobCards.length },
                { id: 'materials', label: 'Materials', icon: <Tool className="h-5 w-5" />, count: materials.length },
                { id: 'drafts', label: 'My Drafts', icon: <Package className="h-5 w-5" />, count: drafts.length },
                { id: 'deadlines', label: 'Deadlines', icon: <Calendar className="h-5 w-5" />, count: stats.dueToday },
              ].map((tab) => (
                <button
                  key={tab.id}
                            ...
                            <div className="flex items-center">
                              <div className="flex-shrink-0 h-10 w-10">
                                <div className="h-10 w-10 rounded-full bg-gray-200 flex items-center justify-center">
                                  <Tool className="h-6 w-6 text-gray-500" />
                                </div>
                              </div>
                              <div className="ml-4">
                      ...
                      <div className="flex justify-between items-start">
                        <div>
                          ...
                          <p className="text-sm text-gray-500">
                            Order #{draft.order?.order_number} • Submitted on {new Date(draft.submitted_at).toLocaleDateString()}
                          </p>
                        </div>
                        <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
