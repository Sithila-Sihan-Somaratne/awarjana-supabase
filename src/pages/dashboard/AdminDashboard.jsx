      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-8">
              ...
              <section>
                ...
                <div className="space-y-4">
                  {pendingDrafts.map((draft) => (
                    <div
                      key={draft.id}
                      className="bg-white dark:bg-gray-900 p-6 rounded-[2rem] border-2 border-amber-100 dark:border-amber-900/30 shadow-sm flex justify-between items-center"
                    >
            ...
            {/* 2. Production Queue */}
            <section>
              <h2 className="text-xl font-black uppercase tracking-tight mb-6 text-gray-400">
                Production Queue
              </h2>
              <div className="space-y-4">
                {orders
                  ...
                  .map((order) => {
                    ...
                    return (
                      <div
                        key={order.id}
                        className="bg-white dark:bg-gray-900 p-6 rounded-[2.5rem] border dark:border-gray-800 shadow-sm flex flex-col md:flex-row justify-between items-center gap-6"
                      >
