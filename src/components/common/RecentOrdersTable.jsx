          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-gray-200 dark:border-gray-700">
                <th className="text-left py-3 px-4 text-sm text-gray-500 dark:text-gray-400 font-medium">Order #</th>
                <th className="text-left py-3 px-4 text-sm text-gray-500 dark:text-gray-400 font-medium">Customer</th>
                <th className="text-left py-3 px-4 text-sm text-gray-500 dark:text-gray-400 font-medium">Description</th>
                <th className="text-left py-3 px-4 text-sm text-gray-500 dark:text-gray-400 font-medium">Status</th>
                <th className="text-right py-3 px-4 text-sm text-gray-500 dark:text-gray-400 font-medium">Amount</th>
                <th className="text-left py-3 px-4 text-sm text-gray-500 dark:text-gray-400 font-medium">Date</th>
                {showActions && (
