...
// HELPER FUNCTIONS (Moved outside to avoid Babel/Vite transform errors)
    ...
    <div className="bg-white dark:bg-gray-800 rounded-3xl p-6 shadow-sm border dark:border-gray-700 hover:shadow-md transition-all">
      <div className="flex justify-between items-start mb-4">
        <div>
          ...
          <p className="text-sm text-gray-500 font-bold">{order?.title || 'Untitled Order'}</p>
        </div>
      ...
      <div className="grid grid-cols-2 gap-4 mb-6">
        <div className="bg-gray-50 dark:bg-gray-700/50 p-3 rounded-2xl">
          ...
          <p className="text-sm font-bold dark:text-white">{order?.dimensions || 'N/A'}</p>
        </div>
        <div className="bg-gray-50 dark:bg-gray-700/50 p-3 rounded-2xl">
          <p className="text-[10px] text-gray-400 uppercase font-black">Material</p>
          <p className="text-sm font-bold dark:text-white">{order?.material || 'N/A'}</p>
        </div>
      </div>
